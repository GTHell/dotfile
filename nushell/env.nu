...
$env.PATH = ($env.PATH | split row (char esep)
  ...
  | prepend ($env.HOME | path join gthell .dotnet tools)
  | prepend ($env.HOME | path join .rye shims)
  | prepend "/home/linuxbrew/.linuxbrew/bin"
  | prepend "/home/linuxbrew/.linuxbrew/opt/node@20/bin"
  | prepend "/opt/nvim-linux64/bin")

$env.DOTNET_ROOT = "/home/linuxbrew/.linuxbrew/opt/dotnet/libexec"

# Set PKG_CONFIG_PATH to /usr/lib/pkgconfig on Linux 
$env.PKG_CONFIG_PATH = "/usr/lib/pkgconfig"

# Set vulkan driver file
